...
final class RevisionController
{
   ...
   public function index(Request $req): void
   {
      ...
      foreach (['tipo_revision_id', 'estatus', 'riesgo', 'area_id', 'responsable_id', 'fecha_notificacion_desde', 'fecha_notificacion_hasta', 'fecha_venc_desde', 'fecha_venc_hasta'] as $k) {
         if (isset($req->get[$k])) $q[$k] = $req->get[$k];
      }
   ...
   public function estatus(Request $req): void
   {
      ...
      if ($id <= 0 || $estatus === '') {
         Response::json(['ok' => false, 'error' => ['code' => 'VALIDATION', 'message' => 'id y estatus requeridos']], 400);
         return;
      }
