...
set "SCRIPT=%PROJ_DIR%\bin\revisiones_notif_pre5.php"
set "LOG_DIR=%PROJ_DIR%\storage\logs"
set "LOG_FILE=%LOG_DIR%\revisiones_notif_pre5.log"
...
>>"%LOG_FILE%" echo [%DATESTAMP% %TIMESTAMP%] Iniciando job de notificaciones...
...
>>"%LOG_FILE%" echo [%DATESTAMP% %TIMESTAMP%] Job finalizado.
