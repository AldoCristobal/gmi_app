...
set "SCRIPT=%PROJ_DIR%\bin\cron_rutinas.php"
set "LOG_DIR=%PROJ_DIR%\storage\logs"
set "LOG_FILE=%LOG_DIR%\cron_rutinas.log"
...
>>"%LOG_FILE%" echo [%DATESTAMP% %TIMESTAMP%] Iniciando job de cron_rutinas...
...
>>"%LOG_FILE%" echo [%DATESTAMP% %TIMESTAMP%] Job cron_rutinas finalizado.
